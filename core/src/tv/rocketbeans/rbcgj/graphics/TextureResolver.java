...
public final class TextureResolver {
    ...
    public static Texture resolveTexture(int type, boolean inactive) {
        switch (type) {
            ...
            case RUISIN:
                return getTexture(inactive ? Assets.Textures.RUISIN_DEAD : Assets.Textures.RUISIN_DEAD);
            case ALMOND:
                return getTexture(inactive ? Assets.Textures.ALMOND_DEAD : Assets.Textures.ALMOND_DEAD);
            case BRAZIL:
                return getTexture(inactive ? Assets.Textures.BRAZIL_DEAD : Assets.Textures.BRAZIL_DEAD);
            case CASHEW:
                return getTexture(inactive ? Assets.Textures.CASHEW_DEAD : Assets.Textures.CASHEW_DEAD);
            default:
                return null;
        }
    }
